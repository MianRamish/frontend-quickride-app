  ...
  return (
    <>
      ...
      {open && <div className="fixed inset-0 z-[95] bg-slate-950/55 backdrop-blur-sm" onClick={() => setOpen(false)}>
        <section className="absolute bottom-0 left-0 right-0 mx-auto max-h-[78dvh] max-w-xl overflow-hidden rounded-t-[32px] bg-[#f6f8fb] p-4 pb-[calc(env(safe-area-inset-bottom)+18px)]" onClick={(e) => e.stopPropagation()}>
